...
def chat_with_document(db: Session, *, document_id: str, user_id: str, question: str) -> dict:
    results = search_chunks(document_id=document_id, user_id=user_id, query=question, limit=5)
    ...
    answer = answer_question(question=question, chunks=ordered_chunks)
